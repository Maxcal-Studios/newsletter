                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                <thead>
                                <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Email">Email</th><th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Name">Name</th><th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Status">Status</th></tr>
                                </thead>
                                <tbody>
                                <tr role="row" class="odd">
                                    <td class="sorting_1">name@provider.domain</td>
                                    <td>Name Nachname</td>
                                    <td><i class="fa fa-paper-plane-o bg-blue icon-bg-circle" title="Gesendet"></i></td>
                                </tr>
                                <tr role="row" class="even">
                                    <td class="sorting_1">name@provider.domain</td>
                                    <td>Name Nachname</td>
                                    <td><i class="fa fa-envelope bg-yellow icon-bg-circle" title="Erhalten"></i></td>
                                </tr><tr role="row" class="odd">
                                    <td class="sorting_1">name@provider.domain</td>
                                    <td>Name Nachname</td>
                                    <td><i class="ion ion-android-checkmark-circle bg-green icon-bg-circle" title="Geöffnet"></i></td>
                                ...
                                <tfoot>
                                <tr><th rowspan="1" colspan="1">Email</th><th rowspan="1" colspan="1">Name</th><th rowspan="1" colspan="1">Status</th></tr>
                                </tfoot>
